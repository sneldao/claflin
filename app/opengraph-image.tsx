  ...
  return new ImageResponse(
    <div style={{ width: '100%', height: '100%', display: 'flex', background: '#15251f', color: '#e8e6d9', padding: 36 }}>
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', padding: 44, border: '1px solid #82724f' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', marginTop: 52, fontFamily: 'serif', fontSize: 72, lineHeight: 1.1 }}><span>The pit is downstairs.</span><span style={{ color: '#c5ac78', fontSize: 40 }}>This desk is for deciding.</span></div>
