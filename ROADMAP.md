...
- `/night-desk` redirects to live Jesse Room view (`/?desk=jesse&view=room`). Fixture study: `/night-desk?study=1`. `/` defaults to Hetty/Base after the foyer; Jesse opens from the house directory ([docs/JESSE_DESK.md](docs/JESSE_DESK.md)).
